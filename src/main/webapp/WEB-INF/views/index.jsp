	...
	<div class="main">
		...
		<div class="card upper">
			...
			<div class="btn-row">
				<div class="tile">
					<!-- 버튼 추가 -->
					<form action="${pageContext.request.contextPath}/fridge/list.do"
						...
						<button type="submit"
							...
							<img
								...
								alt="냉장고 열기" /> <span>냉장고 열기</span>
						</button>
					</form>
				</div>
				<div class="tile">
					<!-- 버튼 추가 -->
					<form action="${pageContext.request.contextPath}/fridge/add.do"
						method="get" style="margin: 0;">
						<button type="submit"
							style="background: rgba(102, 205, 170, 0.1); border: 1px solid #168b85; border-radius: 10px; padding: 0.5rem; width: 100%; display: flex; flex-direction: column; align-items: center; text-align: center; cursor: pointer;">
							<img
								src="${pageContext.request.contextPath}/resources/img/food-add.png"
								alt="음식 넣기" /> <span>음식 넣기</span>
						</button>
					</form>
				</div>
			</div>
			...
			<div class="tile-row">
				<div class="tile">
				<!-- 버튼 추가 -->
					<form action="${pageContext.request.contextPath}/ingredient/search.do"
						method="get" style="margin: 0;">
						<button type="submit"
							style="background: rgba(102, 205, 170, 0.1); border: 1px solid #168b85; border-radius: 10px; padding: 0.5rem; width: 100%; display: flex; flex-direction: column; align-items: center; text-align: center; cursor: pointer;">
					<img
						src="${pageContext.request.contextPath}/resources/img/search-food.png"
						alt="음식 정보 검색" /> <span>음식 정보 검색</span>
						</button>
						</form>
				</div>
					...
					<form
						...
						<button type="submit"
							...
							<img
								...
								alt="레시피 추천"
								style="width: 40px; height: 40px; margin-bottom: 0.5rem;" /> <span
								style="font-weight: 700; font-size: 0.875rem; color: #0d6564;">레시피
								추천</span>
						</button>
					</form>
				</div>
